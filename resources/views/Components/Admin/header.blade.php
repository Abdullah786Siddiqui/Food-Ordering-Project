<nav class="fixed top-0 left-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700 shadow-sm">
  <div class="flex items-center justify-between px-2 py-3 lg:px-6">
    ...
    <div class="flex items-center gap-1">
     ...
     <!-- Logo -->
<a href="{{ route('admin.dashboard') }}" class="flex items-center text-2xl font-bold tracking-tight text-gray-800 dark:text-white  transition-colors">
 Admin <span class="text-blue-600 dark:text-blue-400 ml-1">Panel</span>
</a>
