<nav class="fixed top-0 left-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700 shadow-sm">
  <div class="flex items-center justify-between  py-3 ">
    ...
    <div class=" items-center gap-1 hidden md:block ">
      <!-- Sidebar toggle -->
...
<a href="{{ route('delivery.dashboard') }}" class="flex  lg:ml-4 items-center text-2xl font-bold tracking-tight text-gray-800 dark:text-white  transition-colors">
 Delivery <span class="text-red-600 dark:text-red-400 ml-1">Partners</span>
     ...
     <!-- Logo -->
<a href="{{ route('restaurant.dashboard') }}" class="flex  md:hidden  ml-4 items-center text-2xl font-bold tracking-tight text-gray-800 dark:text-white  transition-colors">
 Delivery <span class="text-red-600 dark:text-red-400 ml-1">Partners</span>
</a>
...
>
  ...
  <div class="absolute right-0 z-50 hidden mt-2 w-80 text-sm bg-white divide-y divide-gray-100 rounded-md shadow-lg dark:bg-gray-800 dark:divide-gray-700"
      ...
      <div class="px-4 py-2 text-center">
          <a href="#" class="text-red-600 dark:text-red-400 hover:underline">View all</a>
      </div>
  </div>
</div>
